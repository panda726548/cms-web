...
public class TopicDto {
	...
	public Topic getTopic() {
		...
		t.setNewName(this.getNewName());
		t.setYuanwenLike(this.getYuanwenLike());
		t.setBrowseNumber(this.browseNumber);
		return t;
	}
	...
	public TopicDto(Topic topic) {
		...
		this.setNewName(topic.getNewName());
		this.setYuanwenLike(topic.getYuanwenLike());
		this.setBrowseNumber(topic.getBrowseNumber());
	}
