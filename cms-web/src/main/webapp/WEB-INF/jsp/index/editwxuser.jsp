			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" modelAttribute="weiXinUser" name="form1"  method="post">
							<div class="form-group">
								<label for="username" class="col-sm-2 control-label">用户名</label>
								<div class="col-sm-10">
									<input name="username" class="form-control" type="text"
										id="username" value="${weiXinUser.username}" disabled="disabled">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="sex" id="sex" class="form-control">
										<option value="0" <c:if test="${weiXinUser.sex==0}">selected="selected"</c:if>>男</option>
										<option value="1" <c:if test="${weiXinUser.sex==1}">selected="selected"</c:if>>女</option>
									<select>
								</div>
							</div>
							<div class="form-group">
