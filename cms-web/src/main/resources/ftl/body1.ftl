...
<#--indexTopicList 首页文章列表  titleSize标题的长度 showDate=true是否显示...
  showDate=true是否显示日期 df="MM/dd"日期格式 divId div的ID  
  hrefClz 链接样式   hasul=true是否有ul节点 hasPanel_titleDiv=false是否有标题div带等多的节点
  hasId是否有编号-->
<#macro indexTopicList indexTopic titleSize showDate=false  hasUL=true showDot=true df="MM-dd" divId="" hrefClz=""  hasPanel_titleDiv=false hasPanel_bodyDiv=false hasId=true>
				<#if hasUL> <#--如果有ul标签就显示-->
				...
				<div id="#{divId==""?string("","id='${divId}'")} class="panel panel-default"
					...
					<ul class="list-group">
						<#list indexTopic.topics as topic>
							<li class="list-group-item">
								...
								<a href="topic/${topic.id}" target="_blank" title="${topic.title}"> 
...
<div class="container">
		...
		<div class="row">
			...
			<!-- 技术文章 -->
			<div class="col-md-4">
				<@indexTopicList indexTopic=${ts["1"]} titleSize=12 showDate=true  hasUL=true divId="jswz" hasPanel_titleDiv=false hasPanel_bodyDiv=false hasId=true>
					<a style="cursor:pointer;" href="#" onclick="return false;"
							id="new_news_tab">
								${ts["1"].cname}
							</a>
							<span> <a href="channel/${ts['1'].cid"
  ...
  <script type="text/javascript">
	...
	-->
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							<a href="education" target="_blank">资源下载</a> 
							<a class="more" href="education" target="_blank">更多</a>
						</h3>
					</div>
