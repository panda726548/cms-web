...
<div id="content">
	<div id="content_con">
		...
		<div id="notice_rollpic">
			<@indexTopicList indexTopic=ts["7"] titleSize=10 divId="notice" hrefClz="index_link">
				<span><a href="channel/${ts["7"].cid}" class="index_title_href">${ts["7"].cname}</a></span>
			</@indexTopicList>
			<div id="rollpic">
		...
		<div id="xwgk_xxgk">
			...
			<@indexTopicList indexTopic=ts["1"] hasH=true hasDt=false titleSize=25 divId="xxgk" hrefClz="index_link">
				<h3><a href="channel/${ts["1"].cid}" class="index_title_href">${ts["1"].cname}</a></h3>
				<div id="xwgk_bg"></div>
			</@indexTopicList>
		</div>
		<div id="hdjx_jyky">
		...
		<div id="hdjx_jyky">
			<@indexTopicList indexTopic=ts["5"] titleSize=31 divId="hdjx" hrefClz="index_link">
				<span class="t_title">${ts["5"].cname}</span><span class="more"><a href="channel/${ts['5'].cid}">更多</a></span>
			</@indexTopicList>
			
			<@indexTopicList indexTopic=ts["6"] titleSize=31 divId="jyky" hrefClz="index_link">
